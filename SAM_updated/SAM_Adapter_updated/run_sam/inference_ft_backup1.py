...
if __name__ == '__main__':
   ...
   # testing data
    ...
    path_output = os.path.join('outputs_pretrained', data_name, size, upsample, uptype)
    ...
    path_model_pretrained = os.path.join(path_model_save, "model_epoch_epoch"+str(model_save_epoch)+".pth")
    pretrained_dict = torch.load(path_model_pretrained, map_location=torch.device('cuda'))
