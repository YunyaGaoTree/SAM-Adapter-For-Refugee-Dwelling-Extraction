...
def save_predicted_probability_mask_shapefile(config, pred_whole_img, thres, path_out, upsample):
...
# main function
def inference_main(model, config, thres, path_out, upsample):
    ...
    gt_path = config["test_dataset"]["dataset"]["args"]["root_path_2"]
    ...
    save_predicted_probability_mask_shapefile(config, prob_mask, thres, path_out, upsample)
